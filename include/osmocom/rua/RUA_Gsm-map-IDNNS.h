...
typedef struct RUA_Gsm_map_IDNNS {
	struct RUA_Gsm_map_IDNNS__routingbasis {
		...
		union RUA_Gsm_map_IDNNS__RUA_routingbasis_u {
...
extern asn_SEQUENCE_specifics_t asn_SPC_RUA_Gsm_map_IDNNS_specs_1;
extern asn_TYPE_member_t asn_MBR_RUA_Gsm_map_IDNNS_1[2];
