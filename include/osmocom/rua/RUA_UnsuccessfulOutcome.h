...
/* Dependencies */
typedef enum RUA_UnsuccessfulOutcome__value_PR {
	RUA_UnsuccessfulOutcome__value_PR_NOTHING	/* No components present */
	
} RUA_UnsuccessfulOutcome__value_PR;
...
typedef struct RUA_UnsuccessfulOutcome {
	...
	struct RUA_UnsuccessfulOutcome__value {
		RUA_UnsuccessfulOutcome__value_PR present;
		union RUA_UnsuccessfulOutcome__RUA_value_u {
		} choice;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RUA_UnsuccessfulOutcome_specs_1;
extern asn_TYPE_member_t asn_MBR_RUA_UnsuccessfulOutcome_1[3];
