...
struct RANAP_TNLInformationEnhRelInfoRes;
struct RANAP_Ass_RAB_Parameters;
...
typedef struct RANAP_RAB_SetupItem_EnhRelocInfoRes {
	...
	struct RANAP_TNLInformationEnhRelInfoRes	*dataForwardingInformation;	/* OPTIONAL */
	struct RANAP_Ass_RAB_Parameters	*ass_RAB_Parameters;	/* OPTIONAL */
