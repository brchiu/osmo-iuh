...
typedef struct RANAP_EnhancedRelocationCompleteResponse {
	RANAP_ProtocolIE_Container_7748P26_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_EnhancedRelocationCompleteResponse_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_EnhancedRelocationCompleteResponse_1[2];
