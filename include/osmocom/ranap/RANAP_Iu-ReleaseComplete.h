...
typedef struct RANAP_Iu_ReleaseComplete {
	RANAP_ProtocolIE_Container_7748P1_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_Iu_ReleaseComplete_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_Iu_ReleaseComplete_1[2];
