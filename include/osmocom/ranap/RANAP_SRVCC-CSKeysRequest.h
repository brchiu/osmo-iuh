...
typedef struct RANAP_SRVCC_CSKeysRequest {
	RANAP_ProtocolIE_Container_7748P78_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_SRVCC_CSKeysRequest_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_SRVCC_CSKeysRequest_1[2];
