...
typedef struct RANAP_Iu_ReleaseRequest {
	RANAP_ProtocolIE_Container_7748P22_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_Iu_ReleaseRequest_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_Iu_ReleaseRequest_1[2];
