...
/* Forward definitions */
typedef struct RANAP_LA_LIST__Member {
	RANAP_LAC_t	 lAC;
...
typedef struct RANAP_LA_LIST {
	A_SEQUENCE_OF(LA_LIST__Member) list;
...
extern asn_SET_OF_specifics_t asn_SPC_RANAP_LA_LIST_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_LA_LIST_1[1];
extern asn_per_constraints_t asn_PER_type_RANAP_LA_LIST_constr_1;
