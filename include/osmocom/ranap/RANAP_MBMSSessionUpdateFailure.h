...
typedef struct RANAP_MBMSSessionUpdateFailure {
	RANAP_ProtocolIE_Container_7748P64_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_MBMSSessionUpdateFailure_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_MBMSSessionUpdateFailure_1[2];
