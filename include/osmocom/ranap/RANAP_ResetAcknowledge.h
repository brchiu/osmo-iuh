...
typedef struct RANAP_ResetAcknowledge {
	RANAP_ProtocolIE_Container_7748P18_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_ResetAcknowledge_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_ResetAcknowledge_1[2];
