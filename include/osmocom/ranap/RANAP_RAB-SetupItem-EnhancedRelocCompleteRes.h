...
struct RANAP_IuTransportAssociation;
...
typedef struct RANAP_RAB_SetupItem_EnhancedRelocCompleteRes {
	...
	struct RANAP_IuTransportAssociation	*iuTransportAssociationRes1;	/* OPTIONAL */
	struct RANAP_RAB_ToBeReleasedList_EnhancedRelocCompleteRes	*rab2beReleasedList;	/* OPTIONAL */
