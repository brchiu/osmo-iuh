...
typedef struct RANAP_MBMSUELinkingRequest {
	RANAP_ProtocolIE_Container_7748P67_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_MBMSUELinkingRequest_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_MBMSUELinkingRequest_1[2];
