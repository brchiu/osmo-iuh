...
typedef struct RANAP_LocationRelatedDataResponse {
	RANAP_ProtocolIE_Container_7748P49_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_LocationRelatedDataResponse_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_LocationRelatedDataResponse_1[2];
