...
typedef struct RANAP_SRNS_DataForwardCommand {
	RANAP_ProtocolIE_Container_7748P40_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_SRNS_DataForwardCommand_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_SRNS_DataForwardCommand_1[2];
