...
typedef struct RANAP_DataVolumeReport {
	RANAP_ProtocolIE_Container_7748P16_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_DataVolumeReport_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_DataVolumeReport_1[2];
