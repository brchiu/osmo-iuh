...
typedef struct RANAP_MBMSSessionStart {
	RANAP_ProtocolIE_Container_7748P59_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_MBMSSessionStart_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_MBMSSessionStart_1[2];
