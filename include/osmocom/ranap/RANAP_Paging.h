...
typedef struct RANAP_Paging {
	RANAP_ProtocolIE_Container_7748P29_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_Paging_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_Paging_1[2];
