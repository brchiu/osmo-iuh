...
typedef struct RANAP_RANAP_EnhancedRelocationInformationResponse {
	RANAP_ProtocolIE_Container_7748P46_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_RANAP_EnhancedRelocationInformationResponse_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_RANAP_EnhancedRelocationInformationResponse_1[2];
