...
typedef RANAP_RAB_IE_ContainerPairList_1095P0_t	 RANAP_RAB_SetupOrModifyList_t;
...
oer_type_decoder_f RANAP_RAB_SetupOrModifyList_decode_oer;
oer_type_encoder_f RANAP_RAB_SetupOrModifyList_encode_oer;
