...
typedef struct RANAP_InformationTransferFailure {
	RANAP_ProtocolIE_Container_7748P53_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_InformationTransferFailure_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_InformationTransferFailure_1[2];
