...
typedef struct RANAP_LocationRelatedDataRequest {
	RANAP_ProtocolIE_Container_7748P48_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_LocationRelatedDataRequest_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_LocationRelatedDataRequest_1[2];
