...
typedef struct RANAP_RelocationCommand {
	RANAP_ProtocolIE_Container_7748P3_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_RelocationCommand_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_RelocationCommand_1[2];
