...
/* Implementation */
extern asn_per_constraints_t asn_PER_type_RANAP_Cell_Id_constr_1;
...
oer_type_decoder_f RANAP_Cell_Id_decode_oer;
oer_type_encoder_f RANAP_Cell_Id_encode_oer;
