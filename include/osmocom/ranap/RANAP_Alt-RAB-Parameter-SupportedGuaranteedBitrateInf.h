...
struct RANAP_Alt_RAB_Parameter_SupportedGuaranteedBitrates;
...
typedef struct RANAP_Alt_RAB_Parameter_SupportedGuaranteedBitrateInf {
	...
	struct RANAP_Alt_RAB_Parameter_SupportedGuaranteedBitrates	*altSupportedGuaranteedBitrates;	/* OPTIONAL */
