...
typedef struct RANAP_RelocationPreparationFailure {
	RANAP_ProtocolIE_Container_7748P4_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_RelocationPreparationFailure_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_RelocationPreparationFailure_1[2];
