...
typedef struct RANAP_DataVolumeReportRequest {
	RANAP_ProtocolIE_Container_7748P15_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_DataVolumeReportRequest_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_DataVolumeReportRequest_1[2];
