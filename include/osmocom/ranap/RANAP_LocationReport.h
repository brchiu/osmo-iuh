...
typedef struct RANAP_LocationReport {
	RANAP_ProtocolIE_Container_7748P34_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_LocationReport_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_LocationReport_1[2];
