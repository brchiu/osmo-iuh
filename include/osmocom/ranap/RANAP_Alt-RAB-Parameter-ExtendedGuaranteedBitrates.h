...
struct RANAP_Alt_RAB_Parameter_ExtendedGuaranteedBitrateList;

/* RANAP_Alt-RAB-Parameter-ExtendedGuaranteedBitrates */
typedef struct RANAP_Alt_RAB_Parameter_ExtendedGuaranteedBitrates {
	A_SEQUENCE_OF(struct RANAP_Alt_RAB_Parameter_ExtendedGuaranteedBitrateList) list;
...
extern asn_SET_OF_specifics_t asn_SPC_RANAP_Alt_RAB_Parameter_ExtendedGuaranteedBitrates_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_Alt_RAB_Parameter_ExtendedGuaranteedBitrates_1[1];
extern asn_per_constraints_t asn_PER_type_RANAP_Alt_RAB_Parameter_ExtendedGuaranteedBitrates_constr_1;
