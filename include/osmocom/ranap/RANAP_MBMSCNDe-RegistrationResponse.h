...
typedef struct RANAP_MBMSCNDe_RegistrationResponse {
	RANAP_ProtocolIE_Container_7748P73_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_MBMSCNDe_RegistrationResponse_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_MBMSCNDe_RegistrationResponse_1[2];
