...
typedef struct RANAP_SecurityModeComplete {
	RANAP_ProtocolIE_Container_7748P13_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_SecurityModeComplete_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_SecurityModeComplete_1[2];
