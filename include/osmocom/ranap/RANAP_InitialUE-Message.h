...
typedef struct RANAP_InitialUE_Message {
	RANAP_ProtocolIE_Container_7748P35_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_InitialUE_Message_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_InitialUE_Message_1[2];
