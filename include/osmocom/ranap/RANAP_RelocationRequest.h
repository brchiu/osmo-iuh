...
typedef struct RANAP_RelocationRequest {
	RANAP_ProtocolIE_Container_7748P5_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_RelocationRequest_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_RelocationRequest_1[2];
