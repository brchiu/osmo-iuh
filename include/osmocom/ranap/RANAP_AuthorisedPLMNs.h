...
struct RANAP_AuthorisedSNAs;
struct RANAP_ProtocolExtensionContainer;

/* Forward definitions */
typedef struct RANAP_AuthorisedPLMNs__Member {
	RANAP_PLMNidentity_t	 pLMNidentity;
	struct RANAP_AuthorisedSNAs	*authorisedSNAsList;	/* OPTIONAL */
...
} AuthorisedPLMNs__Member;

/* RANAP_AuthorisedPLMNs */
typedef struct RANAP_AuthorisedPLMNs {
	A_SEQUENCE_OF(AuthorisedPLMNs__Member) list;
...
extern asn_SET_OF_specifics_t asn_SPC_RANAP_AuthorisedPLMNs_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_AuthorisedPLMNs_1[1];
extern asn_per_constraints_t asn_PER_type_RANAP_AuthorisedPLMNs_constr_1;
