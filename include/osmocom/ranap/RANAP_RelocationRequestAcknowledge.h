...
typedef struct RANAP_RelocationRequestAcknowledge {
	RANAP_ProtocolIE_Container_7748P6_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_RelocationRequestAcknowledge_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_RelocationRequestAcknowledge_1[2];
