...
struct RANAP_EUTRANFrequencies;
...
typedef struct RANAP_IRATmeasurementParameters {
	...
	struct RANAP_EUTRANFrequencies	*eUTRANFrequencies;	/* OPTIONAL */
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_IRATmeasurementParameters_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_IRATmeasurementParameters_1[3];
