...
typedef struct RANAP_SecurityModeCommand {
	RANAP_ProtocolIE_Container_7748P12_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_SecurityModeCommand_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_SecurityModeCommand_1[2];
