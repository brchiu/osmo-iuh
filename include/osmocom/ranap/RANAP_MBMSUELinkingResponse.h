...
typedef struct RANAP_MBMSUELinkingResponse {
	RANAP_ProtocolIE_Container_7748P68_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_MBMSUELinkingResponse_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_MBMSUELinkingResponse_1[2];
