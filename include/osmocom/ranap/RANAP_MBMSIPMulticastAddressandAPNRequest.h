...
typedef struct RANAP_MBMSIPMulticastAddressandAPNRequest {
	A_SEQUENCE_OF(struct RANAP_TMGI) list;
...
extern asn_SET_OF_specifics_t asn_SPC_RANAP_MBMSIPMulticastAddressandAPNRequest_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_MBMSIPMulticastAddressandAPNRequest_1[1];
extern asn_per_constraints_t asn_PER_type_RANAP_MBMSIPMulticastAddressandAPNRequest_constr_1;
