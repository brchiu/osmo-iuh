...
typedef struct RANAP_RANAP_RelocationInformation {
	RANAP_ProtocolIE_Container_7748P44_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_RANAP_RelocationInformation_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_RANAP_RelocationInformation_1[2];
