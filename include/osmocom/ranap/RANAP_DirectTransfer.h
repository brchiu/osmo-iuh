...
typedef struct RANAP_DirectTransfer {
	RANAP_ProtocolIE_Container_7748P36_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_DirectTransfer_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_DirectTransfer_1[2];
