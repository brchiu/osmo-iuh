...
typedef struct RANAP_MBMSSessionUpdate {
	RANAP_ProtocolIE_Container_7748P62_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_MBMSSessionUpdate_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_MBMSSessionUpdate_1[2];
