...
/* Implementation */
extern asn_per_constraints_t asn_PER_type_RANAP_TraceRecordingSessionReference_constr_1;
...
oer_type_decoder_f RANAP_TraceRecordingSessionReference_decode_oer;
oer_type_encoder_f RANAP_TraceRecordingSessionReference_encode_oer;
