...
typedef struct RANAP_ErrorIndication {
	RANAP_ProtocolIE_Container_7748P39_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_ErrorIndication_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_ErrorIndication_1[2];
