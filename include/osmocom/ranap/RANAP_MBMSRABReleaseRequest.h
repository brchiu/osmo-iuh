...
typedef struct RANAP_MBMSRABReleaseRequest {
	RANAP_ProtocolIE_Container_7748P75_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_MBMSRABReleaseRequest_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_MBMSRABReleaseRequest_1[2];
