...
typedef struct RANAP_LocationReportingControl {
	RANAP_ProtocolIE_Container_7748P33_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_LocationReportingControl_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_LocationReportingControl_1[2];
