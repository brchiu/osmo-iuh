...
typedef struct RANAP_UplinkInformationExchangeResponse {
	RANAP_ProtocolIE_Container_7748P57_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_UplinkInformationExchangeResponse_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_UplinkInformationExchangeResponse_1[2];
