...
/* Forward definitions */
typedef struct RANAP_GA_Polygon__Member {
...
typedef struct RANAP_GA_Polygon {
	A_SEQUENCE_OF(GA_Polygon__Member) list;
...
extern asn_SET_OF_specifics_t asn_SPC_RANAP_GA_Polygon_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_GA_Polygon_1[1];
extern asn_per_constraints_t asn_PER_type_RANAP_GA_Polygon_constr_1;
