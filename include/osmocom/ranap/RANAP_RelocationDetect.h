...
typedef struct RANAP_RelocationDetect {
	RANAP_ProtocolIE_Container_7748P23_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_RelocationDetect_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_RelocationDetect_1[2];
