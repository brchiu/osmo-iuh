...
struct RANAP_Alt_RAB_Parameter_MaxBitrates;
...
typedef struct RANAP_Alt_RAB_Parameter_MaxBitrateInf {
	...
	struct RANAP_Alt_RAB_Parameter_MaxBitrates	*altMaxBitrates;	/* OPTIONAL */
	/*
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_Alt_RAB_Parameter_MaxBitrateInf_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_Alt_RAB_Parameter_MaxBitrateInf_1[2];
