...
typedef struct RANAP_MBMSRegistrationRequest {
	RANAP_ProtocolIE_Container_7748P69_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_MBMSRegistrationRequest_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_MBMSRegistrationRequest_1[2];
