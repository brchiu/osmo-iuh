...
typedef struct RANAP_UplinkInformationExchangeFailure {
	RANAP_ProtocolIE_Container_7748P58_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_UplinkInformationExchangeFailure_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_UplinkInformationExchangeFailure_1[2];
