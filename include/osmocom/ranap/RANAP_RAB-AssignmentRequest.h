...
typedef struct RANAP_RAB_AssignmentRequest {
	RANAP_ProtocolIE_Container_7748P42_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_RAB_AssignmentRequest_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_RAB_AssignmentRequest_1[2];
