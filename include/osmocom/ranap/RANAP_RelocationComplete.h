...
typedef struct RANAP_RelocationComplete {
	RANAP_ProtocolIE_Container_7748P24_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_RelocationComplete_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_RelocationComplete_1[2];
