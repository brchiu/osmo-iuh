...
typedef struct RANAP_UeRadioCapabilityMatchRequest {
	RANAP_ProtocolIE_Container_7748P80_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_UeRadioCapabilityMatchRequest_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_UeRadioCapabilityMatchRequest_1[2];
