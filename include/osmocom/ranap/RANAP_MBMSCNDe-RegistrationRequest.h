...
typedef struct RANAP_MBMSCNDe_RegistrationRequest {
	RANAP_ProtocolIE_Container_7748P72_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_MBMSCNDe_RegistrationRequest_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_MBMSCNDe_RegistrationRequest_1[2];
