...
typedef struct RANAP_InformationTransferIndication {
	RANAP_ProtocolIE_Container_7748P51_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_InformationTransferIndication_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_InformationTransferIndication_1[2];
