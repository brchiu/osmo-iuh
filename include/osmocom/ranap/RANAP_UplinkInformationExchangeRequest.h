...
typedef struct RANAP_UplinkInformationExchangeRequest {
	RANAP_ProtocolIE_Container_7748P56_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_UplinkInformationExchangeRequest_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_UplinkInformationExchangeRequest_1[2];
