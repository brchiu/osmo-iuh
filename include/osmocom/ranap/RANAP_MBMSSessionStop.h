...
typedef struct RANAP_MBMSSessionStop {
	RANAP_ProtocolIE_Container_7748P65_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_MBMSSessionStop_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_MBMSSessionStop_1[2];
