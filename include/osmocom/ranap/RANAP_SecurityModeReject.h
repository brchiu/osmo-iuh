...
typedef struct RANAP_SecurityModeReject {
	RANAP_ProtocolIE_Container_7748P14_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_SecurityModeReject_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_SecurityModeReject_1[2];
