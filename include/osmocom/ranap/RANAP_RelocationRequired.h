...
typedef struct RANAP_RelocationRequired {
	RANAP_ProtocolIE_Container_7748P2_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_RelocationRequired_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_RelocationRequired_1[2];
