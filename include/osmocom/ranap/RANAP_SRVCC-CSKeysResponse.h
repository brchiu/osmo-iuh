...
typedef struct RANAP_SRVCC_CSKeysResponse {
	RANAP_ProtocolIE_Container_7748P79_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_SRVCC_CSKeysResponse_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_SRVCC_CSKeysResponse_1[2];
