...
typedef struct RANAP_InformationTransferConfirmation {
	RANAP_ProtocolIE_Container_7748P52_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_InformationTransferConfirmation_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_InformationTransferConfirmation_1[2];
