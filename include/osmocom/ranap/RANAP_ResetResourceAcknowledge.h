...
typedef struct RANAP_ResetResourceAcknowledge {
	RANAP_ProtocolIE_Container_7748P20_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_ResetResourceAcknowledge_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_ResetResourceAcknowledge_1[2];
