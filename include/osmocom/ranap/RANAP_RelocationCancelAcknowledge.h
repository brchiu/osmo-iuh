...
typedef struct RANAP_RelocationCancelAcknowledge {
	RANAP_ProtocolIE_Container_7748P9_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_RelocationCancelAcknowledge_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_RelocationCancelAcknowledge_1[2];
