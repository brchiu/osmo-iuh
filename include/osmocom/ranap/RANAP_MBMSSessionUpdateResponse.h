...
typedef struct RANAP_MBMSSessionUpdateResponse {
	RANAP_ProtocolIE_Container_7748P63_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_MBMSSessionUpdateResponse_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_MBMSSessionUpdateResponse_1[2];
