...
/* Implementation */
extern asn_per_constraints_t asn_PER_type_RANAP_MBMS_PTP_RAB_ID_constr_1;
...
oer_type_decoder_f RANAP_MBMS_PTP_RAB_ID_decode_oer;
oer_type_encoder_f RANAP_MBMS_PTP_RAB_ID_encode_oer;
