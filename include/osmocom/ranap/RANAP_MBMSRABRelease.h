...
typedef struct RANAP_MBMSRABRelease {
	RANAP_ProtocolIE_Container_7748P76_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_MBMSRABRelease_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_MBMSRABRelease_1[2];
