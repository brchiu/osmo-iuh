...
typedef struct RANAP_CN_InvokeTrace {
	RANAP_ProtocolIE_Container_7748P31_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_CN_InvokeTrace_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_CN_InvokeTrace_1[2];
