...
typedef struct RANAP_UESpecificInformationIndication {
	RANAP_ProtocolIE_Container_7748P54_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_UESpecificInformationIndication_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_UESpecificInformationIndication_1[2];
