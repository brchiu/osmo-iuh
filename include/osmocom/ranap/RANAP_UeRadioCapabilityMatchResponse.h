...
typedef struct RANAP_UeRadioCapabilityMatchResponse {
	RANAP_ProtocolIE_Container_7748P81_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_UeRadioCapabilityMatchResponse_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_UeRadioCapabilityMatchResponse_1[2];
