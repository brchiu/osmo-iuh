...
typedef struct RANAP_ResetResource {
	RANAP_ProtocolIE_Container_7748P19_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_ResetResource_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_ResetResource_1[2];
