...
typedef struct RANAP_MBMSSessionStopResponse {
	RANAP_ProtocolIE_Container_7748P66_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_MBMSSessionStopResponse_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_MBMSSessionStopResponse_1[2];
