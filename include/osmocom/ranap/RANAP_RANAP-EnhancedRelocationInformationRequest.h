...
typedef struct RANAP_RANAP_EnhancedRelocationInformationRequest {
	RANAP_ProtocolIE_Container_7748P45_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_RANAP_EnhancedRelocationInformationRequest_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_RANAP_EnhancedRelocationInformationRequest_1[2];
