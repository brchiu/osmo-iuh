...
typedef struct RANAP_MBMSSessionStartFailure {
	RANAP_ProtocolIE_Container_7748P61_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_MBMSSessionStartFailure_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_MBMSSessionStartFailure_1[2];
