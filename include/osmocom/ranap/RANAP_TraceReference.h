...
/* Implementation */
extern asn_per_constraints_t asn_PER_type_RANAP_TraceReference_constr_1;
...
oer_type_decoder_f RANAP_TraceReference_decode_oer;
oer_type_encoder_f RANAP_TraceReference_encode_oer;
