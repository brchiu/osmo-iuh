...
typedef struct RANAP_MBMSRegistrationFailure {
	RANAP_ProtocolIE_Container_7748P71_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_MBMSRegistrationFailure_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_MBMSRegistrationFailure_1[2];
