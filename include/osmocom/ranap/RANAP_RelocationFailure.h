...
typedef struct RANAP_RelocationFailure {
	RANAP_ProtocolIE_Container_7748P7_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_RelocationFailure_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_RelocationFailure_1[2];
