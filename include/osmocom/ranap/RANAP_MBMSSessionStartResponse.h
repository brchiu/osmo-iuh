...
typedef struct RANAP_MBMSSessionStartResponse {
	RANAP_ProtocolIE_Container_7748P60_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_MBMSSessionStartResponse_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_MBMSSessionStartResponse_1[2];
