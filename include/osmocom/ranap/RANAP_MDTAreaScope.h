...
extern asn_CHOICE_specifics_t asn_SPC_RANAP_MDTAreaScope_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_MDTAreaScope_1[4];
extern asn_per_constraints_t asn_PER_type_RANAP_MDTAreaScope_constr_1;
