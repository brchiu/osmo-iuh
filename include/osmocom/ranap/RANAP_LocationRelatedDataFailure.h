...
typedef struct RANAP_LocationRelatedDataFailure {
	RANAP_ProtocolIE_Container_7748P50_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_LocationRelatedDataFailure_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_LocationRelatedDataFailure_1[2];
