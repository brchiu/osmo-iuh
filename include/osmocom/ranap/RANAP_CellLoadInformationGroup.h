...
struct RANAP_CellLoadInformation;
...
typedef struct RANAP_CellLoadInformationGroup {
	...
	struct RANAP_CellLoadInformation	*uplinkCellLoadInformation;	/* OPTIONAL */
	struct RANAP_CellLoadInformation	*downlinkCellLoadInformation;	/* OPTIONAL */
