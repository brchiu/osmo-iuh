...
typedef struct RANAP_CN_DeactivateTrace {
	RANAP_ProtocolIE_Container_7748P32_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_CN_DeactivateTrace_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_CN_DeactivateTrace_1[2];
