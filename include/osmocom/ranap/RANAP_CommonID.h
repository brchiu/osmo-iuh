...
typedef struct RANAP_CommonID {
	RANAP_ProtocolIE_Container_7748P30_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_CommonID_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_CommonID_1[2];
