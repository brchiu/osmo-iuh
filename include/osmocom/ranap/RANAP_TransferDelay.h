...
/* Implementation */
extern asn_per_constraints_t asn_PER_type_RANAP_TransferDelay_constr_1;
...
oer_type_decoder_f RANAP_TransferDelay_decode_oer;
oer_type_encoder_f RANAP_TransferDelay_encode_oer;
