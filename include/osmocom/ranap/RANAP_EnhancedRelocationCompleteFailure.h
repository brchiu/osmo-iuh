...
typedef struct RANAP_EnhancedRelocationCompleteFailure {
	RANAP_ProtocolIE_Container_7748P27_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_EnhancedRelocationCompleteFailure_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_EnhancedRelocationCompleteFailure_1[2];
