...
typedef struct RANAP_EnhancedRelocationCompleteConfirm {
	RANAP_ProtocolIE_Container_7748P28_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_EnhancedRelocationCompleteConfirm_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_EnhancedRelocationCompleteConfirm_1[2];
