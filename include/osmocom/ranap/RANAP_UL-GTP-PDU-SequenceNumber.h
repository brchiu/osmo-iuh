...
/* Implementation */
extern asn_per_constraints_t asn_PER_type_RANAP_UL_GTP_PDU_SequenceNumber_constr_1;
...
oer_type_decoder_f RANAP_UL_GTP_PDU_SequenceNumber_decode_oer;
oer_type_encoder_f RANAP_UL_GTP_PDU_SequenceNumber_encode_oer;
