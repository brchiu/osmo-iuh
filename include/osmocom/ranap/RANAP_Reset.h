...
typedef struct RANAP_Reset {
	RANAP_ProtocolIE_Container_7748P17_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_Reset_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_Reset_1[2];
