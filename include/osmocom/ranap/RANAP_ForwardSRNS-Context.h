...
typedef struct RANAP_ForwardSRNS_Context {
	RANAP_ProtocolIE_Container_7748P41_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_ForwardSRNS_Context_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_ForwardSRNS_Context_1[2];
