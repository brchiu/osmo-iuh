...
typedef struct RANAP_RAB_ModifyRequest {
	RANAP_ProtocolIE_Container_7748P47_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_RAB_ModifyRequest_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_RAB_ModifyRequest_1[2];
