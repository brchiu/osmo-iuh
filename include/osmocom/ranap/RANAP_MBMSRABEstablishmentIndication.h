...
typedef struct RANAP_MBMSRABEstablishmentIndication {
	RANAP_ProtocolIE_Container_7748P74_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_RANAP_MBMSRABEstablishmentIndication_specs_1;
extern asn_TYPE_member_t asn_MBR_RANAP_MBMSRABEstablishmentIndication_1[2];
