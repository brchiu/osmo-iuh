...
typedef struct CSGMembershipUpdate {
	ProtocolIE_Container_1608P8_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_CSGMembershipUpdate_specs_1;
extern asn_TYPE_member_t asn_MBR_CSGMembershipUpdate_1[2];
