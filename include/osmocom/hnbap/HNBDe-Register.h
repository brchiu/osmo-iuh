...
typedef struct HNBDe_Register {
	ProtocolIE_Container_1608P3_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_HNBDe_Register_specs_1;
extern asn_TYPE_member_t asn_MBR_HNBDe_Register_1[2];
