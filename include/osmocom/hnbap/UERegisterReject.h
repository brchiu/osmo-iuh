...
typedef struct UERegisterReject {
	ProtocolIE_Container_1608P6_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_UERegisterReject_specs_1;
extern asn_TYPE_member_t asn_MBR_UERegisterReject_1[2];
