...
typedef struct HNBRegisterAccept {
	ProtocolIE_Container_1608P1_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_HNBRegisterAccept_specs_1;
extern asn_TYPE_member_t asn_MBR_HNBRegisterAccept_1[2];
