...
typedef enum UnsuccessfulOutcome__value_PR {
	...
	UnsuccessfulOutcome__value_PR_HNBRegisterReject,
	UnsuccessfulOutcome__value_PR_UERegisterReject,
	UnsuccessfulOutcome__value_PR_TNLUpdateFailure
...
typedef struct UnsuccessfulOutcome {
	...
	struct UnsuccessfulOutcome__value {
		...
		union UnsuccessfulOutcome__value_u {
			HNBRegisterReject_t	 HNBRegisterReject;
			UERegisterReject_t	 UERegisterReject;
			TNLUpdateFailure_t	 TNLUpdateFailure;
		} choice;
