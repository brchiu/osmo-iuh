...
typedef struct TNLUpdateResponse {
	ProtocolIE_Container_1608P10_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_TNLUpdateResponse_specs_1;
extern asn_TYPE_member_t asn_MBR_TNLUpdateResponse_1[2];
