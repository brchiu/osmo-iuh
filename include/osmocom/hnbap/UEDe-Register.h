...
typedef struct UEDe_Register {
	ProtocolIE_Container_1608P7_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_UEDe_Register_specs_1;
extern asn_TYPE_member_t asn_MBR_UEDe_Register_1[2];
