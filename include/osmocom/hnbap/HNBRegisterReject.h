...
typedef struct HNBRegisterReject {
	ProtocolIE_Container_1608P2_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_HNBRegisterReject_specs_1;
extern asn_TYPE_member_t asn_MBR_HNBRegisterReject_1[2];
