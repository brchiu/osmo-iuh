...
typedef struct HNBRegisterRequest {
	ProtocolIE_Container_1608P0_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_HNBRegisterRequest_specs_1;
extern asn_TYPE_member_t asn_MBR_HNBRegisterRequest_1[2];
