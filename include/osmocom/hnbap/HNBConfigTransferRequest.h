...
typedef struct HNBConfigTransferRequest {
	ProtocolIE_Container_1608P12_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_HNBConfigTransferRequest_specs_1;
extern asn_TYPE_member_t asn_MBR_HNBConfigTransferRequest_1[2];
