...
extern asn_CHOICE_specifics_t asn_SPC_HNB_RNL_Identity_specs_1;
extern asn_TYPE_member_t asn_MBR_HNB_RNL_Identity_1[1];
extern asn_per_constraints_t asn_PER_type_HNB_RNL_Identity_constr_1;
