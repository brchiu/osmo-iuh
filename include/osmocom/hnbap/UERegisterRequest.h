...
typedef struct UERegisterRequest {
	ProtocolIE_Container_1608P4_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_UERegisterRequest_specs_1;
extern asn_TYPE_member_t asn_MBR_UERegisterRequest_1[2];
