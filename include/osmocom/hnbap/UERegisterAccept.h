...
typedef struct UERegisterAccept {
	ProtocolIE_Container_1608P5_t	 protocolIEs;
...
extern asn_SEQUENCE_specifics_t asn_SPC_UERegisterAccept_specs_1;
extern asn_TYPE_member_t asn_MBR_UERegisterAccept_1[2];
