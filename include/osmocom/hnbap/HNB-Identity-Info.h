...
/* Implementation */
extern asn_per_constraints_t asn_PER_type_HNB_Identity_Info_constr_1;
...
oer_type_decoder_f HNB_Identity_Info_decode_oer;
oer_type_encoder_f HNB_Identity_Info_encode_oer;
