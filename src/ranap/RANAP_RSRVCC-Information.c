...
static int
memb_RANAP_iMSInformation_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
...
static asn_oer_constraints_t asn_OER_memb_RANAP_iMSInformation_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..32)) */};
static asn_per_constraints_t asn_PER_memb_RANAP_iMSInformation_constr_3 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
...
static asn_TYPE_member_t asn_MBR_RANAP_RSRVCC_Information_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RANAP_RSRVCC_Information, iMSInformation),
		...
		0,
		{ &asn_OER_memb_RANAP_iMSInformation_constr_3, &asn_PER_memb_RANAP_iMSInformation_constr_3,  memb_RANAP_iMSInformation_constraint_1 },
		0, 0, /* No default value */
		"iMSInformation"
		},
	{ ATF_POINTER, 1, offsetof(struct RANAP_RSRVCC_Information, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_RANAP_ProtocolExtensionContainer_7796P184,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
