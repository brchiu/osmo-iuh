...
static int
memb_RANAP_horizontalUncertaintySpeed_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static int
memb_RANAP_verticalUncertaintySpeed_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static asn_oer_constraints_t asn_OER_memb_RANAP_horizontalUncertaintySpeed_constr_4 CC_NOTUSED = {
	{ 1, 1 }	/* (0..255) */,
	-1};
static asn_per_constraints_t asn_PER_memb_RANAP_horizontalUncertaintySpeed_constr_4 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 8,  8,  0,  255 }	/* (0..255) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_memb_RANAP_verticalUncertaintySpeed_constr_5 CC_NOTUSED = {
	{ 1, 1 }	/* (0..255) */,
	-1};
static asn_per_constraints_t asn_PER_memb_RANAP_verticalUncertaintySpeed_constr_5 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 8,  8,  0,  255 }	/* (0..255) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_RANAP_HorizontalWithVerticalVelocityAndUncertainty_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RANAP_HorizontalWithVerticalVelocityAndUncertainty, horizontalUncertaintySpeed),
		...
		0,
		{ &asn_OER_memb_RANAP_horizontalUncertaintySpeed_constr_4, &asn_PER_memb_RANAP_horizontalUncertaintySpeed_constr_4,  memb_RANAP_horizontalUncertaintySpeed_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RANAP_HorizontalWithVerticalVelocityAndUncertainty, verticalUncertaintySpeed),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_RANAP_verticalUncertaintySpeed_constr_5, &asn_PER_memb_RANAP_verticalUncertaintySpeed_constr_5,  memb_RANAP_verticalUncertaintySpeed_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 1, offsetof(struct RANAP_HorizontalWithVerticalVelocityAndUncertainty, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_RANAP_ProtocolExtensionContainer_7796P217,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
...
asn_SEQUENCE_specifics_t asn_SPC_RANAP_HorizontalWithVerticalVelocityAndUncertainty_specs_1 = {
