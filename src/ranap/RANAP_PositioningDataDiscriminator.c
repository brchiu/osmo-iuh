...
int
RANAP_PositioningDataDiscriminator_constraint(const asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static asn_oer_constraints_t asn_OER_type_RANAP_PositioningDataDiscriminator_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	4	/* (SIZE(4..4)) */};
asn_per_constraints_t asn_PER_type_RANAP_PositioningDataDiscriminator_constr_1 CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_RANAP_PositioningDataDiscriminator = {
	...
	sizeof(asn_DEF_RANAP_PositioningDataDiscriminator_tags_1)
		/sizeof(asn_DEF_RANAP_PositioningDataDiscriminator_tags_1[0]), /* 1 */
	{ &asn_OER_type_RANAP_PositioningDataDiscriminator_constr_1, &asn_PER_type_RANAP_PositioningDataDiscriminator_constr_1, RANAP_PositioningDataDiscriminator_constraint },
	0, 0,	/* No members */
