...
int
RANAP_UnsuccessfullyTransmittedDataVolume_constraint(const asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static asn_oer_constraints_t asn_OER_type_RANAP_UnsuccessfullyTransmittedDataVolume_constr_1 CC_NOTUSED = {
	{ 4, 1 }	/* (0..4294967295) */,
	-1};
asn_per_constraints_t asn_PER_type_RANAP_UnsuccessfullyTransmittedDataVolume_constr_1 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 32, -1,  0,  4294967295 }	/* (0..4294967295) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
const asn_INTEGER_specifics_t asn_SPC_RANAP_UnsuccessfullyTransmittedDataVolume_specs_1 = {
	0,	0,	0,	0,	0,
	0,	/* Native long size */
...
asn_TYPE_descriptor_t asn_DEF_RANAP_UnsuccessfullyTransmittedDataVolume = {
	...
	sizeof(asn_DEF_RANAP_UnsuccessfullyTransmittedDataVolume_tags_1)
		/sizeof(asn_DEF_RANAP_UnsuccessfullyTransmittedDataVolume_tags_1[0]), /* 1 */
	{ &asn_OER_type_RANAP_UnsuccessfullyTransmittedDataVolume_constr_1, &asn_PER_type_RANAP_UnsuccessfullyTransmittedDataVolume_constr_1, RANAP_UnsuccessfullyTransmittedDataVolume_constraint },
	0, 0,	/* No members */
