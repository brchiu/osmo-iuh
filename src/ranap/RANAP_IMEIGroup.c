...
static int
memb_RANAP_iMEIMask_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_oer_constraints_t asn_OER_memb_RANAP_iMEIMask_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	7	/* (SIZE(7..7)) */};
static asn_per_constraints_t asn_PER_memb_RANAP_iMEIMask_constr_3 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 0,  0,  7,  7 }	/* (SIZE(7..7)) */,
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_RANAP_IMEIGroup_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RANAP_IMEIGroup, iMEIMask),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_RANAP_iMEIMask_constr_3, &asn_PER_memb_RANAP_iMEIMask_constr_3,  memb_RANAP_iMEIMask_constraint_1 },
		0, 0, /* No default value */
		"iMEIMask"
		},
	{ ATF_POINTER, 1, offsetof(struct RANAP_IMEIGroup, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_RANAP_ProtocolExtensionContainer_7796P149,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
...
asn_SEQUENCE_specifics_t asn_SPC_RANAP_IMEIGroup_specs_1 = {
