...
static asn_oer_constraints_t asn_OER_memb_RANAP_threshold_constr_3 CC_NOTUSED = {
	{ 2, 0 }	/* (-120..165) */,
	-1};
static asn_per_constraints_t asn_PER_memb_RANAP_threshold_constr_3 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 9,  9, -120,  165 }	/* (-120..165) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_RANAP_Event1F_Parameters_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RANAP_Event1F_Parameters, threshold),
		...
		0,
		{ &asn_OER_memb_RANAP_threshold_constr_3, &asn_PER_memb_RANAP_threshold_constr_3,  memb_RANAP_threshold_constraint_1 },
		0, 0, /* No default value */
		"threshold"
		},
};
...
asn_SEQUENCE_specifics_t asn_SPC_RANAP_Event1F_Parameters_specs_1 = {
