...
static int
memb_RANAP_ageOfSAI_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_oer_constraints_t asn_OER_memb_RANAP_ageOfSAI_constr_3 CC_NOTUSED = {
	{ 2, 1 }	/* (0..32767) */,
	-1};
static asn_per_constraints_t asn_PER_memb_RANAP_ageOfSAI_constr_3 CC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_RANAP_LastKnownServiceArea_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RANAP_LastKnownServiceArea, ageOfSAI),
		...
		0,
		{ &asn_OER_memb_RANAP_ageOfSAI_constr_3, &asn_PER_memb_RANAP_ageOfSAI_constr_3,  memb_RANAP_ageOfSAI_constraint_1 },
		0, 0, /* No default value */
		"ageOfSAI"
		},
	{ ATF_POINTER, 1, offsetof(struct RANAP_LastKnownServiceArea, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_RANAP_ProtocolExtensionContainer_7796P156,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
