...
static asn_oer_constraints_t asn_OER_type_RANAP_JoinedMBMSBearerService_IEs_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..128)) */};
asn_per_constraints_t asn_PER_type_RANAP_JoinedMBMSBearerService_IEs_constr_1 CC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_RANAP_Member_2[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct RANAP_JoinedMBMSBearerService_IEs__Member, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_RANAP_ProtocolExtensionContainer_7796P13,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
...
asn_TYPE_member_t asn_MBR_RANAP_JoinedMBMSBearerService_IEs_1[] = {
	{ ATF_POINTER, 0, 0,
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
...
asn_SET_OF_specifics_t asn_SPC_RANAP_JoinedMBMSBearerService_IEs_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_RANAP_JoinedMBMSBearerService_IEs = {
	...
	sizeof(asn_DEF_RANAP_JoinedMBMSBearerService_IEs_tags_1)
		/sizeof(asn_DEF_RANAP_JoinedMBMSBearerService_IEs_tags_1[0]), /* 1 */
	{ &asn_OER_type_RANAP_JoinedMBMSBearerService_IEs_constr_1, &asn_PER_type_RANAP_JoinedMBMSBearerService_IEs_constr_1, SEQUENCE_OF_constraint },
