...
asn_TYPE_member_t asn_MBR_RANAP_TransportLayerInformation_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct RANAP_TransportLayerInformation, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_RANAP_ProtocolExtensionContainer_7796P64,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
...
asn_SEQUENCE_specifics_t asn_SPC_RANAP_TransportLayerInformation_specs_1 = {
