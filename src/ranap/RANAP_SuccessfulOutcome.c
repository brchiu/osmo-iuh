...
select_SuccessfulOutcome_RANAP_criticality_type(const asn_TYPE_descriptor_t *parent_type, const void *parent_sptr) {
	...
	const long *constraining_value = (const long *)((const char *)parent_sptr + offsetof(struct RANAP_SuccessfulOutcome, procedureCode));
...
static asn_type_selector_result_t
select_SuccessfulOutcome_RANAP_value_type(const asn_TYPE_descriptor_t *parent_type, const void *parent_sptr) {
	asn_type_selector_result_t result = {0, 0};
	const asn_ioc_set_t *itable = asn_IOS_RANAP_RANAP_ELEMENTARY_PROCEDURES_1;
	size_t constraining_column = 4; /* &procedureCode */
...
static asn_TYPE_member_t asn_MBR_RANAP_value_4[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RANAP_SuccessfulOutcome__value, choice.Iu_ReleaseComplete),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RANAP_SuccessfulOutcome__value, choice.RelocationCommand),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_RANAP_RelocationCommand,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"RelocationCommand"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct RANAP_SuccessfulOutcome__value, choice.RelocationRequestAcknowledge),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_RANAP_RelocationRequestAcknowledge,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"RelocationRequestAcknowledge"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct RANAP_SuccessfulOutcome__value, choice.RelocationCancelAcknowledge),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RANAP_SuccessfulOutcome__value, choice.SRNS_ContextResponse),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RANAP_SuccessfulOutcome__value, choice.SecurityModeComplete),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RANAP_SuccessfulOutcome__value, choice.DataVolumeReport),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_RANAP_DataVolumeReport,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"DataVolumeReport"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct RANAP_SuccessfulOutcome__value, choice.ResetAcknowledge),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RANAP_SuccessfulOutcome__value, choice.ResetResourceAcknowledge),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RANAP_SuccessfulOutcome__value, choice.LocationRelatedDataResponse),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RANAP_SuccessfulOutcome__value, choice.InformationTransferConfirmation),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_RANAP_InformationTransferConfirmation,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"InformationTransferConfirmation"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct RANAP_SuccessfulOutcome__value, choice.UplinkInformationExchangeResponse),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RANAP_SuccessfulOutcome__value, choice.MBMSSessionStartResponse),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_RANAP_MBMSSessionStartResponse,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"MBMSSessionStartResponse"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct RANAP_SuccessfulOutcome__value, choice.MBMSSessionUpdateResponse),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_RANAP_MBMSSessionUpdateResponse,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"MBMSSessionUpdateResponse"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct RANAP_SuccessfulOutcome__value, choice.MBMSSessionStopResponse),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_RANAP_MBMSSessionStopResponse,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"MBMSSessionStopResponse"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct RANAP_SuccessfulOutcome__value, choice.MBMSRegistrationResponse),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RANAP_SuccessfulOutcome__value, choice.MBMSCNDe_RegistrationResponse),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_RANAP_MBMSCNDe_RegistrationResponse,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"MBMSCNDe-RegistrationResponse"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct RANAP_SuccessfulOutcome__value, choice.MBMSRABRelease),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_RANAP_MBMSRABRelease,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"MBMSRABRelease"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct RANAP_SuccessfulOutcome__value, choice.EnhancedRelocationCompleteResponse),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RANAP_SuccessfulOutcome__value, choice.RANAP_EnhancedRelocationInformationResponse),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_RANAP_RANAP_EnhancedRelocationInformationResponse,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
...
static const asn_TYPE_tag2member_t asn_MAP_RANAP_value_tag2el_4[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 0, 0, 19 }, /* Iu-ReleaseComplete */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 1, -1, 18 }, /* RelocationCommand */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 2, -2, 17 }, /* RelocationRequestAcknowledge */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 3, -3, 16 }, /* RelocationCancelAcknowledge */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 4, -4, 15 }, /* SRNS-ContextResponse */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 5, -5, 14 }, /* SecurityModeComplete */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 6, -6, 13 }, /* DataVolumeReport */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 7, -7, 12 }, /* ResetAcknowledge */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 8, -8, 11 }, /* ResetResourceAcknowledge */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 9, -9, 10 }, /* LocationRelatedDataResponse */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 10, -10, 9 }, /* InformationTransferConfirmation */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 11, -11, 8 }, /* UplinkInformationExchangeResponse */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 12, -12, 7 }, /* MBMSSessionStartResponse */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 13, -13, 6 }, /* MBMSSessionUpdateResponse */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 14, -14, 5 }, /* MBMSSessionStopResponse */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 15, -15, 4 }, /* MBMSRegistrationResponse */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 16, -16, 3 }, /* MBMSCNDe-RegistrationResponse */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 17, -17, 2 }, /* MBMSRABRelease */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 18, -18, 1 }, /* EnhancedRelocationCompleteResponse */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 19, -19, 0 } /* RANAP-EnhancedRelocationInformationResponse */
};
static asn_CHOICE_specifics_t asn_SPC_RANAP_value_specs_4 = {
	sizeof(struct RANAP_SuccessfulOutcome__value),
	offsetof(struct RANAP_SuccessfulOutcome__value, _asn_ctx),
	offsetof(struct RANAP_SuccessfulOutcome__value, present),
	sizeof(((struct RANAP_SuccessfulOutcome__value *)0)->present),
...
asn_TYPE_member_t asn_MBR_RANAP_SuccessfulOutcome_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RANAP_SuccessfulOutcome, criticality),
		...
		select_SuccessfulOutcome_RANAP_criticality_type,
		{ &asn_OER_memb_RANAP_criticality_constr_3, &asn_PER_memb_RANAP_criticality_constr_3,  memb_RANAP_criticality_constraint_1 },
		0, 0, /* No default value */
		"criticality"
		},
	{ ATF_OPEN_TYPE | ATF_NOFLAGS, 0, offsetof(struct RANAP_SuccessfulOutcome, value),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_RANAP_value_4,
		select_SuccessfulOutcome_RANAP_value_type,
...
asn_SEQUENCE_specifics_t asn_SPC_RANAP_SuccessfulOutcome_specs_1 = {
