...
asn_TYPE_member_t asn_MBR_RANAP_PrivateMessage_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RANAP_PrivateMessage, privateIEs),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_RANAP_PrivateIE_Container_7812P0,
		0,
		{ 0, 0, 0 },
...
asn_SEQUENCE_specifics_t asn_SPC_RANAP_PrivateMessage_specs_1 = {
