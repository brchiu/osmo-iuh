...
static asn_oer_constraints_t asn_OER_type_RANAP_CriticalityDiagnostics_IE_List_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..256)) */};
asn_per_constraints_t asn_PER_type_RANAP_CriticalityDiagnostics_IE_List_constr_1 CC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_RANAP_Member_2[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct RANAP_CriticalityDiagnostics_IE_List__Member, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_RANAP_ProtocolExtensionContainer_7796P135,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
...
static const int asn_MAP_RANAP_Member_oms_2[] = { 2, 3 };
...
asn_TYPE_member_t asn_MBR_RANAP_CriticalityDiagnostics_IE_List_1[] = {
	{ ATF_POINTER, 0, 0,
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
...
asn_SET_OF_specifics_t asn_SPC_RANAP_CriticalityDiagnostics_IE_List_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_RANAP_CriticalityDiagnostics_IE_List = {
	...
	sizeof(asn_DEF_RANAP_CriticalityDiagnostics_IE_List_tags_1)
		/sizeof(asn_DEF_RANAP_CriticalityDiagnostics_IE_List_tags_1[0]), /* 1 */
	{ &asn_OER_type_RANAP_CriticalityDiagnostics_IE_List_constr_1, &asn_PER_type_RANAP_CriticalityDiagnostics_IE_List_constr_1, SEQUENCE_OF_constraint },
