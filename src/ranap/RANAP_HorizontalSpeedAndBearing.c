...
static int
memb_RANAP_bearing_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static int
memb_RANAP_horizontalSpeed_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static asn_oer_constraints_t asn_OER_memb_RANAP_bearing_constr_2 CC_NOTUSED = {
	{ 2, 1 }	/* (0..359) */,
	-1};
static asn_per_constraints_t asn_PER_memb_RANAP_bearing_constr_2 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 9,  9,  0,  359 }	/* (0..359) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_memb_RANAP_horizontalSpeed_constr_3 CC_NOTUSED = {
	{ 2, 1 }	/* (0..2047) */,
	-1};
static asn_per_constraints_t asn_PER_memb_RANAP_horizontalSpeed_constr_3 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 11,  11,  0,  2047 }	/* (0..2047) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_RANAP_HorizontalSpeedAndBearing_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RANAP_HorizontalSpeedAndBearing, bearing),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_RANAP_bearing_constr_2, &asn_PER_memb_RANAP_bearing_constr_2,  memb_RANAP_bearing_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RANAP_HorizontalSpeedAndBearing, horizontalSpeed),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_RANAP_horizontalSpeed_constr_3, &asn_PER_memb_RANAP_horizontalSpeed_constr_3,  memb_RANAP_horizontalSpeed_constraint_1 },
		0, 0, /* No default value */
		"horizontalSpeed"
		},
};
...
asn_SEQUENCE_specifics_t asn_SPC_RANAP_HorizontalSpeedAndBearing_specs_1 = {
