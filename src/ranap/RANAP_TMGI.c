...
static int
memb_RANAP_serviceID_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_oer_constraints_t asn_OER_memb_RANAP_serviceID_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	3	/* (SIZE(3..3)) */};
static asn_per_constraints_t asn_PER_memb_RANAP_serviceID_constr_3 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 0,  0,  3,  3 }	/* (SIZE(3..3)) */,
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_RANAP_TMGI_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RANAP_TMGI, serviceID),
		...
		0,
		{ &asn_OER_memb_RANAP_serviceID_constr_3, &asn_PER_memb_RANAP_serviceID_constr_3,  memb_RANAP_serviceID_constraint_1 },
		0, 0, /* No default value */
		"serviceID"
		},
	{ ATF_POINTER, 1, offsetof(struct RANAP_TMGI, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_RANAP_ProtocolExtensionContainer_7796P203,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
...
asn_SEQUENCE_specifics_t asn_SPC_RANAP_TMGI_specs_1 = {
