...
int
RANAP_RAB_FailedList_constraint(const asn_TYPE_descriptor_t *td, const void *sptr,
...
/*
 * This type is implemented using RANAP_RAB_IE_ContainerList_1094P6,
 * so here we adjust the DEF accordingly.
 */
static asn_oer_constraints_t asn_OER_type_RANAP_RAB_FailedList_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..256)) */};
asn_per_constraints_t asn_PER_type_RANAP_RAB_FailedList_constr_1 CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_RANAP_RAB_FailedList = {
	...
	sizeof(asn_DEF_RANAP_RAB_FailedList_tags_1)
		/sizeof(asn_DEF_RANAP_RAB_FailedList_tags_1[0]), /* 1 */
	{ &asn_OER_type_RANAP_RAB_FailedList_constr_1, &asn_PER_type_RANAP_RAB_FailedList_constr_1, RANAP_RAB_FailedList_constraint },
