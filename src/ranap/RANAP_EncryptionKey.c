...
int
RANAP_EncryptionKey_constraint(const asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static asn_oer_constraints_t asn_OER_type_RANAP_EncryptionKey_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	128	/* (SIZE(128..128)) */};
asn_per_constraints_t asn_PER_type_RANAP_EncryptionKey_constr_1 CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_RANAP_EncryptionKey = {
	...
	sizeof(asn_DEF_RANAP_EncryptionKey_tags_1)
		/sizeof(asn_DEF_RANAP_EncryptionKey_tags_1[0]), /* 1 */
	{ &asn_OER_type_RANAP_EncryptionKey_constr_1, &asn_PER_type_RANAP_EncryptionKey_constr_1, RANAP_EncryptionKey_constraint },
	0, 0,	/* No members */
