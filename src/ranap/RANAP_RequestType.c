...
static int
memb_RANAP_accuracyCode_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_oer_constraints_t asn_OER_memb_RANAP_accuracyCode_constr_4 CC_NOTUSED = {
	{ 1, 1 }	/* (0..127) */,
	-1};
static asn_per_constraints_t asn_PER_memb_RANAP_accuracyCode_constr_4 CC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_RANAP_RequestType_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct RANAP_RequestType, accuracyCode),
		...
		0,
		{ &asn_OER_memb_RANAP_accuracyCode_constr_4, &asn_PER_memb_RANAP_accuracyCode_constr_4,  memb_RANAP_accuracyCode_constraint_1 },
		0, 0, /* No default value */
		"accuracyCode"
		},
};
