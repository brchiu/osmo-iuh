...
asn_TYPE_member_t asn_MBR_RANAP_RANAP_EnhancedRelocationInformationResponse_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RANAP_RANAP_EnhancedRelocationInformationResponse, protocolIEs),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_RANAP_ProtocolIE_Container_7748P46,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"protocolIEs"
		},
	{ ATF_POINTER, 1, offsetof(struct RANAP_RANAP_EnhancedRelocationInformationResponse, protocolExtensions),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_RANAP_ProtocolExtensionContainer_7796P78,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"protocolExtensions"
...
static const int asn_MAP_RANAP_RANAP_EnhancedRelocationInformationResponse_oms_1[] = { 1 };
...
asn_SEQUENCE_specifics_t asn_SPC_RANAP_RANAP_EnhancedRelocationInformationResponse_specs_1 = {
	...
	asn_MAP_RANAP_RANAP_EnhancedRelocationInformationResponse_oms_1,	/* Optional members */
	1, 0,	/* Root/Additions */
