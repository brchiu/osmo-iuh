...
static int
memb_RANAP_uncertaintyAltitude_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_oer_constraints_t asn_OER_memb_RANAP_uncertaintyAltitude_constr_5 CC_NOTUSED = {
	{ 1, 1 }	/* (0..127) */,
	-1};
static asn_per_constraints_t asn_PER_memb_RANAP_uncertaintyAltitude_constr_5 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 7,  7,  0,  127 }	/* (0..127) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_memb_RANAP_confidence_constr_6 CC_NOTUSED = {
	{ 1, 1 }	/* (0..127) */,
	-1};
static asn_per_constraints_t asn_PER_memb_RANAP_confidence_constr_6 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 7,  7,  0,  127 }	/* (0..127) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_RANAP_GA_PointWithAltitudeAndUncertaintyEllipsoid_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RANAP_GA_PointWithAltitudeAndUncertaintyEllipsoid, uncertaintyAltitude),
		...
		0,
		{ &asn_OER_memb_RANAP_uncertaintyAltitude_constr_5, &asn_PER_memb_RANAP_uncertaintyAltitude_constr_5,  memb_RANAP_uncertaintyAltitude_constraint_1 },
		0, 0, /* No default value */
		"uncertaintyAltitude"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct RANAP_GA_PointWithAltitudeAndUncertaintyEllipsoid, confidence),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_RANAP_confidence_constr_6, &asn_PER_memb_RANAP_confidence_constr_6,  memb_RANAP_confidence_constraint_1 },
		0, 0, /* No default value */
		"confidence"
		},
	{ ATF_POINTER, 1, offsetof(struct RANAP_GA_PointWithAltitudeAndUncertaintyEllipsoid, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_RANAP_ProtocolExtensionContainer_7796P144,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
...
asn_SEQUENCE_specifics_t asn_SPC_RANAP_GA_PointWithAltitudeAndUncertaintyEllipsoid_specs_1 = {
