...
static int
memb_RANAP_reportingAmount_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static int
memb_RANAP_reportingInterval_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static asn_oer_constraints_t asn_OER_memb_RANAP_reportingAmount_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_memb_RANAP_reportingAmount_constr_2 CC_NOTUSED = {
	{ APC_CONSTRAINED | APC_EXTENSIBLE,  24, -1,  1,  8639999 }	/* (1..8639999,...) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_memb_RANAP_reportingInterval_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_memb_RANAP_reportingInterval_constr_3 CC_NOTUSED = {
	{ APC_CONSTRAINED | APC_EXTENSIBLE,  24, -1,  1,  8639999 }	/* (1..8639999,...) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_RANAP_PeriodicLocationInfo_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RANAP_PeriodicLocationInfo, reportingAmount),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_RANAP_reportingAmount_constr_2, &asn_PER_memb_RANAP_reportingAmount_constr_2,  memb_RANAP_reportingAmount_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RANAP_PeriodicLocationInfo, reportingInterval),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_RANAP_reportingInterval_constr_3, &asn_PER_memb_RANAP_reportingInterval_constr_3,  memb_RANAP_reportingInterval_constraint_1 },
		0, 0, /* No default value */
		"reportingInterval"
		},
	{ ATF_POINTER, 1, offsetof(struct RANAP_PeriodicLocationInfo, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_RANAP_ProtocolExtensionContainer_7796P165,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
...
asn_SEQUENCE_specifics_t asn_SPC_RANAP_PeriodicLocationInfo_specs_1 = {
