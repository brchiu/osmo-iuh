...
int
PSC_constraint(const asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static asn_oer_constraints_t asn_OER_type_PSC_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	9	/* (SIZE(9..9)) */};
asn_per_constraints_t asn_PER_type_PSC_constr_1 CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_PSC = {
	...
	sizeof(asn_DEF_PSC_tags_1)
		/sizeof(asn_DEF_PSC_tags_1[0]), /* 1 */
	{ &asn_OER_type_PSC_constr_1, &asn_PER_type_PSC_constr_1, PSC_constraint },
	0, 0,	/* No members */
