...
static asn_TYPE_member_t asn_MBR_value_4[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SuccessfulOutcome__value, choice.HNBRegisterAccept),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SuccessfulOutcome__value, choice.UERegisterAccept),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SuccessfulOutcome__value, choice.TNLUpdateResponse),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_TNLUpdateResponse,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"TNLUpdateResponse"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct SuccessfulOutcome__value, choice.HNBConfigTransferResponse),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_HNBConfigTransferResponse,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"HNBConfigTransferResponse"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct SuccessfulOutcome__value, choice.U_RNTIQueryResponse),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_U_RNTIQueryResponse,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"U-RNTIQueryResponse"
...
static const asn_TYPE_tag2member_t asn_MAP_value_tag2el_4[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 0, 0, 4 }, /* HNBRegisterAccept */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 1, -1, 3 }, /* UERegisterAccept */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 2, -2, 2 }, /* TNLUpdateResponse */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 3, -3, 1 }, /* HNBConfigTransferResponse */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 4, -4, 0 } /* U-RNTIQueryResponse */
};
