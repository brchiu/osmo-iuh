...
int
IMEI_constraint(const asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static asn_oer_constraints_t asn_OER_type_IMEI_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	60	/* (SIZE(60..60)) */};
asn_per_constraints_t asn_PER_type_IMEI_constr_1 CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_IMEI = {
	...
	sizeof(asn_DEF_IMEI_tags_1)
		/sizeof(asn_DEF_IMEI_tags_1[0]), /* 1 */
	{ &asn_OER_type_IMEI_constr_1, &asn_PER_type_IMEI_constr_1, IMEI_constraint },
	0, 0,	/* No members */
