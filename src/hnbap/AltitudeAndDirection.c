...
static asn_oer_constraints_t asn_OER_type_directionOfAltitude_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_directionOfAltitude_constr_2 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_memb_altitude_constr_5 CC_NOTUSED = {
	{ 2, 1 }	/* (0..32767) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_directionOfAltitude_2 = {
	...
	{ &asn_OER_type_directionOfAltitude_constr_2, &asn_PER_type_directionOfAltitude_constr_2, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_directionOfAltitude_specs_2	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_AltitudeAndDirection_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct AltitudeAndDirection, altitude),
		...
		0,
		{ &asn_OER_memb_altitude_constr_5, &asn_PER_memb_altitude_constr_5,  memb_altitude_constraint_1 },
		0, 0, /* No default value */
		"altitude"
		},
};
...
asn_SEQUENCE_specifics_t asn_SPC_AltitudeAndDirection_specs_1 = {
