...
int
PTMSI_constraint(const asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static asn_oer_constraints_t asn_OER_type_PTMSI_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	32	/* (SIZE(32..32)) */};
asn_per_constraints_t asn_PER_type_PTMSI_constr_1 CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_PTMSI = {
	...
	sizeof(asn_DEF_PTMSI_tags_1)
		/sizeof(asn_DEF_PTMSI_tags_1[0]), /* 1 */
	{ &asn_OER_type_PTMSI_constr_1, &asn_PER_type_PTMSI_constr_1, PTMSI_constraint },
	0, 0,	/* No members */
