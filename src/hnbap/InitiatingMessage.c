...
static const long asn_VAL_1_id_HNBRegister = 1;
static const long asn_VAL_1_reject = 0;
static const long asn_VAL_2_id_UERegister = 3;
static const long asn_VAL_2_reject = 0;
static const long asn_VAL_3_id_TNLUpdate = 9;
static const long asn_VAL_3_reject = 0;
static const long asn_VAL_4_id_HNBConfigTransfer = 10;
static const long asn_VAL_4_reject = 0;
static const long asn_VAL_5_id_U_RNTIQuery = 14;
static const long asn_VAL_5_reject = 0;
static const long asn_VAL_6_id_UEDe_Register = 4;
static const long asn_VAL_6_ignore = 1;
static const long asn_VAL_7_id_HNBDe_Register = 2;
static const long asn_VAL_7_ignore = 1;
static const long asn_VAL_8_id_ErrorIndication = 5;
static const long asn_VAL_8_ignore = 1;
static const long asn_VAL_9_id_privateMessage = 6;
static const long asn_VAL_9_ignore = 1;
static const long asn_VAL_10_id_CSGMembershipUpdate = 7;
static const long asn_VAL_10_ignore = 1;
static const long asn_VAL_11_id_RelocationComplete = 11;
static const long asn_VAL_11_ignore = 1;
static const asn_ioc_cell_t asn_IOS_HNBAP_ELEMENTARY_PROCEDURES_1_rows[] = {
	{ "&InitiatingMessage", aioc__type, &asn_DEF_HNBRegisterRequest },
	{ "&SuccessfulOutcome", aioc__type, &asn_DEF_HNBRegisterAccept },
	{ "&UnsuccessfulOutcome", aioc__type, &asn_DEF_HNBRegisterReject },
	{ "&procedureCode", aioc__value, &asn_DEF_ProcedureCode, &asn_VAL_1_id_HNBRegister },
	{ "&criticality", aioc__value, &asn_DEF_Criticality, &asn_VAL_1_reject },
	{ "&InitiatingMessage", aioc__type, &asn_DEF_UERegisterRequest },
	{ "&SuccessfulOutcome", aioc__type, &asn_DEF_UERegisterAccept },
	{ "&UnsuccessfulOutcome", aioc__type, &asn_DEF_UERegisterReject },
	{ "&procedureCode", aioc__value, &asn_DEF_ProcedureCode, &asn_VAL_2_id_UERegister },
	{ "&criticality", aioc__value, &asn_DEF_Criticality, &asn_VAL_2_reject },
	{ "&InitiatingMessage", aioc__type, &asn_DEF_TNLUpdateRequest },
	{ "&SuccessfulOutcome", aioc__type, &asn_DEF_TNLUpdateResponse },
	{ "&UnsuccessfulOutcome", aioc__type, &asn_DEF_TNLUpdateFailure },
	{ "&procedureCode", aioc__value, &asn_DEF_ProcedureCode, &asn_VAL_3_id_TNLUpdate },
	{ "&criticality", aioc__value, &asn_DEF_Criticality, &asn_VAL_3_reject },
	{ "&InitiatingMessage", aioc__type, &asn_DEF_HNBConfigTransferRequest },
	{ "&SuccessfulOutcome", aioc__type, &asn_DEF_HNBConfigTransferResponse },
	{ "&UnsuccessfulOutcome",  },
	{ "&procedureCode", aioc__value, &asn_DEF_ProcedureCode, &asn_VAL_4_id_HNBConfigTransfer },
	{ "&criticality", aioc__value, &asn_DEF_Criticality, &asn_VAL_4_reject },
	{ "&InitiatingMessage", aioc__type, &asn_DEF_U_RNTIQueryRequest },
	{ "&SuccessfulOutcome", aioc__type, &asn_DEF_U_RNTIQueryResponse },
	{ "&UnsuccessfulOutcome",  },
	{ "&procedureCode", aioc__value, &asn_DEF_ProcedureCode, &asn_VAL_5_id_U_RNTIQuery },
	{ "&criticality", aioc__value, &asn_DEF_Criticality, &asn_VAL_5_reject },
	{ "&InitiatingMessage", aioc__type, &asn_DEF_UEDe_Register },
	{ "&SuccessfulOutcome",  },
	{ "&UnsuccessfulOutcome",  },
	{ "&procedureCode", aioc__value, &asn_DEF_ProcedureCode, &asn_VAL_6_id_UEDe_Register },
	{ "&criticality", aioc__value, &asn_DEF_Criticality, &asn_VAL_6_ignore },
	{ "&InitiatingMessage", aioc__type, &asn_DEF_HNBDe_Register },
	{ "&SuccessfulOutcome",  },
	{ "&UnsuccessfulOutcome",  },
	{ "&procedureCode", aioc__value, &asn_DEF_ProcedureCode, &asn_VAL_7_id_HNBDe_Register },
	{ "&criticality", aioc__value, &asn_DEF_Criticality, &asn_VAL_7_ignore },
	{ "&InitiatingMessage", aioc__type, &asn_DEF_ErrorIndication },
	{ "&SuccessfulOutcome",  },
	{ "&UnsuccessfulOutcome",  },
	{ "&procedureCode", aioc__value, &asn_DEF_ProcedureCode, &asn_VAL_8_id_ErrorIndication },
	{ "&criticality", aioc__value, &asn_DEF_Criticality, &asn_VAL_8_ignore },
	{ "&InitiatingMessage", aioc__type, &asn_DEF_PrivateMessage },
	{ "&SuccessfulOutcome",  },
	{ "&UnsuccessfulOutcome",  },
	{ "&procedureCode", aioc__value, &asn_DEF_ProcedureCode, &asn_VAL_9_id_privateMessage },
	{ "&criticality", aioc__value, &asn_DEF_Criticality, &asn_VAL_9_ignore },
	{ "&InitiatingMessage", aioc__type, &asn_DEF_CSGMembershipUpdate },
	{ "&SuccessfulOutcome",  },
	{ "&UnsuccessfulOutcome",  },
	{ "&procedureCode", aioc__value, &asn_DEF_ProcedureCode, &asn_VAL_10_id_CSGMembershipUpdate },
	{ "&criticality", aioc__value, &asn_DEF_Criticality, &asn_VAL_10_ignore },
	{ "&InitiatingMessage", aioc__type, &asn_DEF_RelocationComplete },
	{ "&SuccessfulOutcome",  },
	{ "&UnsuccessfulOutcome",  },
	{ "&procedureCode", aioc__value, &asn_DEF_ProcedureCode, &asn_VAL_11_id_RelocationComplete },
	{ "&criticality", aioc__value, &asn_DEF_Criticality, &asn_VAL_11_ignore }
};
static const asn_ioc_set_t asn_IOS_HNBAP_ELEMENTARY_PROCEDURES_1[] = {
	{ 11, 5, asn_IOS_HNBAP_ELEMENTARY_PROCEDURES_1_rows }
};
static int
...
select_InitiatingMessage_criticality_type(const asn_TYPE_descriptor_t *parent_type, const void *parent_sptr) {
	...
	const asn_ioc_set_t *itable = asn_IOS_HNBAP_ELEMENTARY_PROCEDURES_1;
...
static asn_TYPE_member_t asn_MBR_value_4[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct InitiatingMessage__value, choice.HNBRegisterRequest),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct InitiatingMessage__value, choice.UERegisterRequest),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct InitiatingMessage__value, choice.TNLUpdateRequest),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct InitiatingMessage__value, choice.HNBConfigTransferRequest),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct InitiatingMessage__value, choice.U_RNTIQueryRequest),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_U_RNTIQueryRequest,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"U-RNTIQueryRequest"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct InitiatingMessage__value, choice.UEDe_Register),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct InitiatingMessage__value, choice.HNBDe_Register),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct InitiatingMessage__value, choice.CSGMembershipUpdate),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_CSGMembershipUpdate,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"CSGMembershipUpdate"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct InitiatingMessage__value, choice.RelocationComplete),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
...
static const asn_TYPE_tag2member_t asn_MAP_value_tag2el_4[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 0, 0, 10 }, /* HNBRegisterRequest */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 1, -1, 9 }, /* UERegisterRequest */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 2, -2, 8 }, /* TNLUpdateRequest */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 3, -3, 7 }, /* HNBConfigTransferRequest */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 4, -4, 6 }, /* U-RNTIQueryRequest */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 5, -5, 5 }, /* UEDe-Register */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 6, -6, 4 }, /* HNBDe-Register */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 7, -7, 3 }, /* ErrorIndication */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 8, -8, 2 }, /* PrivateMessage */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 9, -9, 1 }, /* CSGMembershipUpdate */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 10, -10, 0 } /* RelocationComplete */
};
