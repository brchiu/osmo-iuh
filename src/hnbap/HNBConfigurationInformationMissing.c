...
asn_TYPE_member_t asn_MBR_HNBConfigurationInformationMissing_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct HNBConfigurationInformationMissing, iE_Extensions),
		...
		&asn_DEF_ProtocolExtensionContainer_1637P26,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
...
asn_SEQUENCE_specifics_t asn_SPC_HNBConfigurationInformationMissing_specs_1 = {
