...
asn_TYPE_member_t asn_MBR_U_RNTIQueryResponse_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct U_RNTIQueryResponse, protocolIEs),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolIE_Container_1608P17,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"protocolIEs"
		},
	{ ATF_POINTER, 1, offsetof(struct U_RNTIQueryResponse, protocolExtensions),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_1637P17,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"protocolExtensions"
...
static const int asn_MAP_U_RNTIQueryResponse_oms_1[] = { 1 };
