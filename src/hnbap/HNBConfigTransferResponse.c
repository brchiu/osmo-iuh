...
asn_TYPE_member_t asn_MBR_HNBConfigTransferResponse_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct HNBConfigTransferResponse, protocolIEs),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolIE_Container_1608P13,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"protocolIEs"
		},
	{ ATF_POINTER, 1, offsetof(struct HNBConfigTransferResponse, protocolExtensions),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_1637P13,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"protocolExtensions"
...
static const int asn_MAP_HNBConfigTransferResponse_oms_1[] = { 1 };
...
asn_SEQUENCE_specifics_t asn_SPC_HNBConfigTransferResponse_specs_1 = {
	...
	asn_MAP_HNBConfigTransferResponse_oms_1,	/* Optional members */
	1, 0,	/* Root/Additions */
