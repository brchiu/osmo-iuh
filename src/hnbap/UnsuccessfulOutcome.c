...
static asn_TYPE_member_t asn_MBR_value_4[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct UnsuccessfulOutcome__value, choice.HNBRegisterReject),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct UnsuccessfulOutcome__value, choice.UERegisterReject),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct UnsuccessfulOutcome__value, choice.TNLUpdateFailure),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_TNLUpdateFailure,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"TNLUpdateFailure"
...
static const asn_TYPE_tag2member_t asn_MAP_value_tag2el_4[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 0, 0, 2 }, /* HNBRegisterReject */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 1, -1, 1 }, /* UERegisterReject */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 2, -2, 0 } /* TNLUpdateFailure */
};
