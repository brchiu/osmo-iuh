...
asn_TYPE_member_t asn_MBR_MacroCoverageInformation_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct MacroCoverageInformation, iE_Extensions),
		...
		&asn_DEF_ProtocolExtensionContainer_1637P30,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
...
asn_SEQUENCE_specifics_t asn_SPC_MacroCoverageInformation_specs_1 = {
