...
int
UDP_Port_Number_constraint(const asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static asn_oer_constraints_t asn_OER_type_UDP_Port_Number_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	2	/* (SIZE(2..2)) */};
asn_per_constraints_t asn_PER_type_UDP_Port_Number_constr_1 CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_UDP_Port_Number = {
	...
	sizeof(asn_DEF_UDP_Port_Number_tags_1)
		/sizeof(asn_DEF_UDP_Port_Number_tags_1[0]), /* 1 */
	{ &asn_OER_type_UDP_Port_Number_constr_1, &asn_PER_type_UDP_Port_Number_constr_1, UDP_Port_Number_constraint },
	0, 0,	/* No members */
