...
asn_TYPE_member_t asn_MBR_RUA_Connect_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RUA_Connect, protocolIEs),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_RUA_ProtocolIE_Container_769P0,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"protocolIEs"
		},
	{ ATF_POINTER, 1, offsetof(struct RUA_Connect, protocolExtensions),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_RUA_ProtocolExtensionContainer_798P0,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"protocolExtensions"
...
static const int asn_MAP_RUA_Connect_oms_1[] = { 1 };
...
asn_SEQUENCE_specifics_t asn_SPC_RUA_Connect_specs_1 = {
	sizeof(struct RUA_Connect),
	offsetof(struct RUA_Connect, _asn_ctx),
	asn_MAP_RUA_Connect_tag2el_1,
	2,	/* Count of tags in the map */
	asn_MAP_RUA_Connect_oms_1,	/* Optional members */
	1, 0,	/* Root/Additions */
