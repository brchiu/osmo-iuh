...
static int
memb_RUA_local_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_oer_constraints_t asn_OER_memb_RUA_local_constr_2 CC_NOTUSED = {
	{ 2, 1 }	/* (0..65535) */,
	-1};
static asn_per_constraints_t asn_PER_memb_RUA_local_constr_2 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 16,  16,  0,  65535 }	/* (0..65535) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_type_RUA_PrivateIE_ID_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
asn_per_constraints_t asn_PER_type_RUA_PrivateIE_ID_constr_1 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_RUA_PrivateIE_ID_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RUA_PrivateIE_ID, choice.local),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_RUA_local_constr_2, &asn_PER_memb_RUA_local_constr_2,  memb_RUA_local_constraint_1 },
...
asn_CHOICE_specifics_t asn_SPC_RUA_PrivateIE_ID_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_RUA_PrivateIE_ID = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_RUA_PrivateIE_ID_constr_1, &asn_PER_type_RUA_PrivateIE_ID_constr_1, CHOICE_constraint },
