...
static asn_oer_constraints_t asn_OER_type_RUA_CriticalityDiagnostics_IE_List_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..256)) */};
asn_per_constraints_t asn_PER_type_RUA_CriticalityDiagnostics_IE_List_constr_1 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 8,  8,  1,  256 }	/* (SIZE(1..256)) */,
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_RUA_Member_2[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct RUA_CriticalityDiagnostics_IE_List__Member, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_RUA_ProtocolExtensionContainer_798P6,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
...
static const int asn_MAP_RUA_Member_oms_2[] = { 3 };
static const ber_tlv_tag_t asn_DEF_RUA_Member_tags_2[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_RUA_Member_tag2el_2[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_RUA_Member_specs_2 = {
	...
	asn_MAP_RUA_Member_tag2el_2,
	4,	/* Count of tags in the map */
	asn_MAP_RUA_Member_oms_2,	/* Optional members */
	1, 0,	/* Root/Additions */
	4,	/* First extension addition */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_RUA_Member_2 = {
	"SEQUENCE",
	"SEQUENCE",
	&asn_OP_SEQUENCE,
	asn_DEF_RUA_Member_tags_2,
	sizeof(asn_DEF_RUA_Member_tags_2)
		/sizeof(asn_DEF_RUA_Member_tags_2[0]), /* 1 */
	asn_DEF_RUA_Member_tags_2,	/* Same as above */
	sizeof(asn_DEF_RUA_Member_tags_2)
		/sizeof(asn_DEF_RUA_Member_tags_2[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_RUA_Member_2,
	4,	/* Elements count */
	&asn_SPC_RUA_Member_specs_2	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_RUA_CriticalityDiagnostics_IE_List_1[] = {
	{ ATF_POINTER, 0, 0,
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_RUA_Member_2,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		""
...
asn_SET_OF_specifics_t asn_SPC_RUA_CriticalityDiagnostics_IE_List_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_RUA_CriticalityDiagnostics_IE_List = {
	...
	sizeof(asn_DEF_RUA_CriticalityDiagnostics_IE_List_tags_1)
		/sizeof(asn_DEF_RUA_CriticalityDiagnostics_IE_List_tags_1[0]), /* 1 */
	{ &asn_OER_type_RUA_CriticalityDiagnostics_IE_List_constr_1, &asn_PER_type_RUA_CriticalityDiagnostics_IE_List_constr_1, SEQUENCE_OF_constraint },
