...
int
RUA_RoutingParameter_constraint(const asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static asn_oer_constraints_t asn_OER_type_RUA_RoutingParameter_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	10	/* (SIZE(10..10)) */};
asn_per_constraints_t asn_PER_type_RUA_RoutingParameter_constr_1 CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_RUA_RoutingParameter = {
	...
	sizeof(asn_DEF_RUA_RoutingParameter_tags_1)
		/sizeof(asn_DEF_RUA_RoutingParameter_tags_1[0]), /* 1 */
	{ &asn_OER_type_RUA_RoutingParameter_constr_1, &asn_PER_type_RUA_RoutingParameter_constr_1, RUA_RoutingParameter_constraint },
	0, 0,	/* No members */
