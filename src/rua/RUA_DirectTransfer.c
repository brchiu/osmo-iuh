...
asn_TYPE_member_t asn_MBR_RUA_DirectTransfer_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RUA_DirectTransfer, protocolIEs),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_RUA_ProtocolIE_Container_769P1,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"protocolIEs"
		},
	{ ATF_POINTER, 1, offsetof(struct RUA_DirectTransfer, protocolExtensions),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_RUA_ProtocolExtensionContainer_798P1,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"protocolExtensions"
...
static const int asn_MAP_RUA_DirectTransfer_oms_1[] = { 1 };
