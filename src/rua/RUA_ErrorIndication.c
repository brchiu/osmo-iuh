...
asn_TYPE_member_t asn_MBR_RUA_ErrorIndication_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RUA_ErrorIndication, protocolIEs),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_RUA_ProtocolIE_Container_769P4,
		0,
		{ 0, 0, 0 },
	...
	{ ATF_POINTER, 1, offsetof(struct RUA_ErrorIndication, protocolExtensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_RUA_ProtocolExtensionContainer_798P4,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"protocolExtensions"
...
static const int asn_MAP_RUA_ErrorIndication_oms_1[] = { 1 };
