...
int
RUA_Ansi_41_IDNNS_constraint(const asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static asn_oer_constraints_t asn_OER_type_RUA_Ansi_41_IDNNS_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	14	/* (SIZE(14..14)) */};
asn_per_constraints_t asn_PER_type_RUA_Ansi_41_IDNNS_constr_1 CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_RUA_Ansi_41_IDNNS = {
	...
	sizeof(asn_DEF_RUA_Ansi_41_IDNNS_tags_1)
		/sizeof(asn_DEF_RUA_Ansi_41_IDNNS_tags_1[0]), /* 1 */
	{ &asn_OER_type_RUA_Ansi_41_IDNNS_constr_1, &asn_PER_type_RUA_Ansi_41_IDNNS_constr_1, RUA_Ansi_41_IDNNS_constraint },
	0, 0,	/* No members */
